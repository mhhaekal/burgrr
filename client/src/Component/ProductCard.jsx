        ...
        <div>
            ...
            <div className="w-[250px] border p-5 flex flex-col gap-5 border-green-600 rounded-3xl shadow-xl">
                <div className="rounded-xl w-full h-[200px]">
                    <img className="w-full h-auto " src="https://bakeitwithlove.com/wp-content/uploads/2021/05/McDonalds-The-Travis-Scott-Burger-sq.jpg" alt="Product" />
                </div>
                <div className="font-black text-lg h-[50px]">
                    {props.name}
                </div>
